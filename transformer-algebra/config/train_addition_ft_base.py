# Fine-tune addition task from shared base checkpoint (Week 1 experiment).
#
# IMPORTANT: copy base checkpoint before running:
#   mkdir -p out/addition_ft && cp out/base/ckpt.pt out/addition_ft/ckpt.pt
#
# Uses data/addition_shared/ which is tokenized with the SAME unified vocabulary
...
wandb_run_name = 'week1-addition-ft'

dataset    = 'addition_shared'
batch_size = 64
block_size = 48
