# train arithmetic model WITHOUT scratchpad (baseline)
# Should struggle with longer numbers (3+ digits)

out_dir = 'out/without_scratchpad'
...
wandb_run_name = 'without-scratchpad-baseline-double-digit'
